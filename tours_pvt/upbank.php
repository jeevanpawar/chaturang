...
$qry_u="select * from bank_info where bank_id='$up'";
...
$count=mysql_num_rows($res_d);
	...
	if(isset($_REQUEST['e_add']))
	{
 		$t1=$_POST['t1'];
		$t2=$_POST['t2'];
 		$qry="update bank_info SET bank_name='".$t1."', bank_acc='".$t2."' where bank_id=".$up;
		$res=mysql_query($qry);
		if($res)
		{
...
<div id="container">
	 <div id="sub-header">
		...
		while($row_d=mysql_fetch_array($res_d))
		{
			...
			echo "</td>";
			echo "<td class='print'>";
			echo "<a href='upbank.php?id=$row_d[0]'>Update</a>";
			echo "</td>";
			echo "</tr>";
		}
		?>
        ...
        <table class="pay">
        <tr class="menu_header"><td colspan="2">Update New Bank</td></tr>
        <tr>
