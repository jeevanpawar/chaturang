...
$qry_d="select * from trans_pay where t_id=".$id;
...
$row_d=mysql_fetch_array($res_d);
	...
	if(isset($_REQUEST['e_add']))
	{
		...
		$pa_qry="insert into reciept(p_id,c_id,b_id,r_date,r_mode,r_no,r_amt,r_word,m_id) values('".$id."','".$c."','".$t1."','".$date."','".$t3."','".$t4."','".$t5."','".$t6."','".$id2."')";
...
<div id="container">
	 <div id="sub-header">
        ...
        <td><input id="des" type="text" class="q_in" name="t3" value="<?php echo $row_d[6]; ?>"></td>
        </tr>
        <tr>
        <td class="l_form">Check No/D.D.No.:</td>
        <td><input id="contact" type="text" class="q_in" name="t4" value="<?php echo $row_d[7]; ?>"></td>
        </tr>
        <tr>
        <td class="l_form">Reciept Amount:</td>
        <td><input id="ename" type="text" readonly name="t5" class="q_in" value="<?php echo $row_d[8]; ?>"></td>
        </tr>
        <tr>
