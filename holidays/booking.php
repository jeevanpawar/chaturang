...
<div id="container">
	...
	?>
        ...
        <form action="" method="post">
         ...
         <td><input class="amt" name="p_mf[]" type="text"></td>
         <td><input class="amt" name="p_age[]" type="text"></td>
         <td><input class="amt" name="p_bdate[]" type="text"></td>
